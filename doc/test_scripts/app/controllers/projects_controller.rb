class ProjectsController < ApplicationController
  ...
  before_filter :get_projects,:only=>[:index,:show_projects,:edit_project_form]
	before_filter :get_mrcs ,:only=>[:index,:live_search]
  before_filter :get_clients ,:only=>[:index,:load_project_form,:edit_project_form,:create,:update,:destroy,:cancel]
